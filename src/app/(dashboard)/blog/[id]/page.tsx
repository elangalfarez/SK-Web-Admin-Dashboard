            ...
            <div className="mt-1 flex flex-wrap items-center gap-2">
              ...
              {post.category && (
                <Badge
                  variant="outline"
                  style={{
                    backgroundColor: (post.category as any).color ? `${(post.category as any).color}20` : undefined,
                    borderColor: (post.category as any).color || undefined,
                    color: (post.category as any).color || undefined,
                  }}
                >
                  {post.category.name}
                </Badge>
        ...
        <div className="space-y-6 lg:col-span-2">
          ...
          {(post as any).excerpt && (
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">{(post as any).excerpt}</p>
              </CardContent>
            </Card>
          )}
            ...
            <Card>
              ...
              <CardContent>
                <div
                  ...
                  dangerouslySetInnerHTML={{ __html: (post as any).body }}
                />
              </CardContent>
            </Card>
          )}
          ...
          {/* SEO Preview */}
          {((post as any).meta_title || (post as any).meta_description) && (
            <Card>
              <CardHeader>
              ...
              <CardContent>
                <div className="space-y-1 rounded-lg border border-border p-4">
                  <p className="text-lg text-primary hover:underline cursor-pointer">
                    {(post as any).meta_title || post.title}
                  </p>
                  <p className="text-sm text-success">
                    supermalkarawaci.co.id/blog/{post.slug}
                  </p>
                  <p className="text-sm text-muted-foreground line-clamp-2">
                    {(post as any).meta_description || (post as any).excerpt || "No description"}
                  </p>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {formatDisplayDateTime((post as any).published_at)}
                    </p>
                  </div>
                </div>
              )}
